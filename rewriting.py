...
ALPHABET_TO_KNOTS: dict[str, list[list[tuple[float, float]]]] = {
    ...
    "b": [[(0.4, 0.2), (0.5, 0.6), (0.3, 1)], [(0.3, 1), (0.7, 1), (0.9, 0.8), (0.9, 0.7), (0.9, 0.2)]],
    "t": [[(0.3, 1), (0.6, 0.3), (0.8, 0.2), (0.9, 0.4), (0.9, 0.8), (0.8, 1), (0.6, 1)]],
    "d": [[(0.3, 1), (0.7, 1.2), (1, 1.5)], [(1, 1.5), (0.8, 0.6), (0.8, 0.2)]],
    "k": [[(0.5, 0.2), (0.6, 0.7), (0.5, 1.2), (0.3, 1.5)], [(0.3, 1.5), (0.6, 1.5), (0.9, 1.4), (1, 1), (1, 0.2)]],
    "g": [[(0.2, 1), (0.5, 1), (0.9, 0.5), (1, 0.2)], [(1, 0.2), (1, 1.1), (1, 1.2), (0.9, 1.5)]],
    "m": [[(0.9, 0.2), (0.7, 0.6), (0.9, 1)], [(0.9, 1), (0.6, 0.9), (0.2, 1)]],
    "n": [[(0.9, 0.2), (0.7, 0.6), (0.9, 1.5)], [(0.9, 1.5), (0.6, 1.4), (0.2, 1.5)]],
    "l": [[(0.2, 1), (0.5, 1), (0.9, 0.5), (1, 0.2)], [(1, 0.2), (1, 1.1), (0.9, 1.4), (0.5, 1.5), (0.2, 1.5)]],
    "r": [[(1, 0.2), (0.4, 1), (0.4, 1.5)], [(0.4, 1.5), (0.7, 1), (1, 1)]],
    "j": [[(1, 0.2), (0.5, 0.5), (0.3, 1)], [(0.3, 1), (0.7, 0.9), (0.9, 1.4), (0.5, 1.5), (0.2, 1.5)]],
    "h": [[(0.6, 0.2), (0.7, 0.6), (0.5, 1), (0.3, 1)], [(0.3, 1), (0.6, 1), (0.7, 1), (0.9, 1.1), (0.8, 1.5)]],
    "s": [[(0.9, 0.2), (0.8, 0.6), (0.3, 1)], [(0.3, 1), (0.6, 1), (0.7, 1), (0.9, 1.1), (0.8, 1.5)]],
